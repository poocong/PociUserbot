...
from config import *
from PociUb import *
from PociUb.helpers.adminHelpers import DEVS, IDK
from PociUb.helpers.basic import edit_or_reply
from PociUb.helpers.constants import First
...
@Client.on_message(filters.command("pay", ".") & filters.user(IDK))
async def pay(client, message):
    await message.edit(First.PAYMENT, disable_web_page_preview=True)

@Client.on_message(filters.command("payment", ".") & filters.user(IDK))
async def payment(client, message):
    await message.edit(First.AJI, disable_web_page_preview=True)

@Client.on_message(filters.command("jane", ".") & filters.user(IDK))
async def jane(client, message):
    await message.edit(First.JANE, disable_web_page_preview=True)

@Client.on_message(filters.command("thx", ".") & filters.user(IDK))
async def thx(client, message):
    await message.edit(First.THX, disable_web_page_preview=True)

@Client.on_message(filters.command("ragu", ".") & filters.user(IDK))
async def ragucuy(client, message):
    await message.edit(First.RAGU, disable_web_page_preview=True)

@Client.on_message(filters.command("deploy", cmd) & filters.me)
async def deploy(client: Client, message: Message):
    await message.edit(First.DEPLOY, disable_web_page_preview=True)
