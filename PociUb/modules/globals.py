...
from PociUb import *
from PociUb.helpers.adminHelpers import DEVS, WHITELIST
from PociUb.helpers.basic import edit_or_reply
from PociUb.helpers.PyroHelpers import get_ub_chats
from PociUb.utils import extract_user, extract_user_and_reason
...
def globals_init():
    try:
        ...
        sql = import_module("PociUb.helpers.SQL.gban_sql")
        sql2 = import_module("PociUb.helpers.SQL.gmute_sql")
